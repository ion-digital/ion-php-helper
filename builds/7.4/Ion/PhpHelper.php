...
class PhpHelper implements PhpHelperInterface
{
    ...
    public static function isEmpty(
        /* mixed */
        $value,
        bool $orWhiteSpaceIfString = true,
        bool $orEmptyIfArray = true
    ) : bool
    {
    ...
    public static function hasDecimals(
        /* mixed */
        $variable = null
    ) : bool
    {
    ...
    //    }
    //
    private static function toScalar(
        /* mixed */
        $variable,
        callable $callBack,
        bool $allowDeserialization = false
    )
    {
    ...
    public static function toArray(
        ...
        $variable = null,
        bool $allowDeserialization = false,
        string $splitCharacterIfString = null
    ) : ?array
    {
    ...
    public static function toString(
        ...
        $variable = null,
        bool $allowDeserialization = false,
        string $joinCharacterIfArray = null
    ) : ?string
    {
    ...
    public static function toBool(
        ...
        $variable = null,
        bool $allowDeserialization = false,
        bool $checkElementsIfArray = false
    ) : ?bool
    {
     ...
     * 
     */
    public static function getServerRequestUri(bool $includeHost = false, bool $includeProtocol = true) : ?string
    {
